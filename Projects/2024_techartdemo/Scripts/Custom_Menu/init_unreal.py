...
def main():
    ...
    entry2.set_label("List Asset Paths")
    print("set label entry 2")
    
    entry2.set_tool_tip("List all of the assets found in designated path.")
    print("set tool tip entry 2")
    
    entry2.set_string_command(unreal.ToolMenuStringCommandType.PYTHON, '', string = 'tutorial_script_recreate.py')
