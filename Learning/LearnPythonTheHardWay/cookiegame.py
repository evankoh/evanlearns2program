...
#if chair pushed to cabinet, not tall enough to reach (leave chair there or put back?)
#if player correctly guesses how many books are in the house, use books to stack and reach; cannot reach (leave the books there or put back?)
#prompt player to input number of books (mini guessing game)
#if too little, too much, almost there
#definite single value
#swinging, if swinging without chair and books at cabinet = too short; if chair only = too short, if books only = too short, if books and chair = can reach
#swinging just yes and no
